...
#создаём окно и запускаем update
width = 640
height = 480
...
pygame.display.set_caption("Snakee game by friz")
...
while not game_end:
    ...
    pygame.draw.rect(display, colors["snake_head"], [
        snake_pos["x"], snake_pos["y"], snake_size[0], snake_size[1]])

    #draw staff
    #pygame.draw.rect( display, (0,255,0), [640/2-5, 480/2-5, 10, 10]) #(0,255,0) - RGB цвет (зелёный)
